...
public class  MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView bookmarkview=(ListView) findViewById(R.id.starResult);
        ...
        inputShop = (EditText) findViewById(R.id.inputShop);
        ...
        bookmarkview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
        ...
        cklistview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent mIntent=new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.lotteon.com/search/search/search.ecn?render=search&platform=pc&q="+cklist.get(i)));
    ...
    public void getVal() {
        ...
        if(strData.length>0){
            ...
            Cursor cursor = db.rawQuery("SELECT B.RECIPE_NM_KO, B.SUMRY, B.IMG_URL, C.RECIPE_COUNT" +
                    ...
                    " ORDER BY RANDOM() limit 10", strData);
